...
$password = $f->get_setting('dba_password');

//directory relative to this file to search for databases (if false, manually list databases in the $databases variable)
$directory = $f->root_path.'/app/databases';
...
class GetParameters
{
	...
	public function redirect(array $assoc = array(), $message="")
	{
		...
		header("Location: ".$protocol."://".$_SERVER['HTTP_HOST'].parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH).$url, true, 302);
		exit;
	}
